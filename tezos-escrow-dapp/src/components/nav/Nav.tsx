...
export const SideNav: React.FC<{collapsed: boolean, setCollapsed: (collapsed: boolean) => void }> = (props) => {
    return <>
                ...
                <div className="card">
                    <div className="card-body p-0 p-md-4">
                        ...
                        <ul id="nav_responsive" className={props.collapsed ? "nav flex-column d-none d-lg-block mt-1 mt-lg-0" : "nav flex-column d-lg-block mt-1 mt-lg-0 d-sm-block bg-white shadow-md border animate-fadein rounded p-3"}>
                            <li>
                                <div className="d-flex align-items-center mb-2 pb-4 border-bottom">
                                <div className="flex-none p-3 border rounded-circle">
                                    <svg className="text-gray-300" width="34px" height="34px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 460.8 460.8" fill="currentColor">
                            ...
                            <li className="nav-item active">
                                <a className="nav-link px-0 d-flex align-items-center" href="account-index.html">
                            ...
                            <li className="nav-item">
                                <a className="nav-link px-0 d-flex align-items-center" href="account-orders.html">
                                    <svg className="text-gray-600 float-start" width="18px" height="18px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                            ...
                            <li className="nav-item">
                            <a className="nav-link px-0 d-flex align-items-center" href="account-favourites.html">
                                <svg className="text-gray-600 float-start" width="18px" height="18px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                            ...
                            <li className="nav-item">
                            <a className="nav-link px-0 d-flex align-items-center" href="account-reward.html">
                                <svg className="text-gray-600 float-start" width="18px" height="18px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                <path fillRule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"></path>
                                <path fillRule="evenodd" d="M11.315 10.014a.5.5 0 0 1 .548.736A4.498 4.498 0 0 1 7.965 13a4.498 4.498 0 0 1-3.898-2.25.5.5 0 0 1 .548-.736h.005l.017.005.067.015.252.055c.215.046.515.108.857.169.693.124 1.522.242 2.152.242.63 0 1.46-.118 2.152-.242a26.58 26.58 0 0 0 1.109-.224l.067-.015.017-.004.005-.002zM4.756 4.566c.763-1.424 4.02-.12.952 3.434-4.496-1.596-2.35-4.298-.952-3.434zm6.488 0c1.398-.864 3.544 1.838-.952 3.434-3.067-3.554.19-4.858.952-3.434z"></path>
                                </svg>
                                <span>Reward points</span>
                            </a>
                            </li>
                            <li className="nav-item">
                            <a className="nav-link px-0 d-flex align-items-center" href="account-coupons.html">
                                <svg className="text-gray-600 float-start" width="18px" height="18px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                <path fillRule="evenodd" d="M10.273 2.513l-.921-.944.715-.698.622.637.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.636a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.011a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01.622-.636a2.89 2.89 0 0 1 4.134 0l-.715.698a1.89 1.89 0 0 0-2.704 0l-.92.944-1.32-.016a1.89 1.89 0 0 0-1.911 1.912l.016 1.318-.944.921a1.89 1.89 0 0 0 0 2.704l.944.92-.016 1.32a1.89 1.89 0 0 0 1.912 1.911l1.318-.016.921.944a1.89 1.89 0 0 0 2.704 0l.92-.944 1.32.016a1.89 1.89 0 0 0 1.911-1.912l-.016-1.318.944-.921a1.89 1.89 0 0 0 0-2.704l-.944-.92.016-1.32a1.89 1.89 0 0 0-1.912-1.911l-1.318.016z"></path>
                                <path fillRule="evenodd" d="M10.354 6.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 8.793l2.646-2.647a.5.5 0 0 1 .708 0z"></path>
                                </svg>
                                <span>Coupons</span>
                            </a>
                            </li>
                            <li className="nav-item">
                            <a className="nav-link px-0 d-flex align-items-center" href="account-reviews.html">
                                <svg className="text-gray-600 float-start" width="18px" height="18px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                            ...
                            <li className="nav-item">
                            <a className="nav-link px-0 d-flex align-items-center" href="account-refunds.html">
                                <svg className="text-gray-600 float-start" width="18px" height="18px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                            ...
                            <li className="nav-item">
                            <a className="nav-link px-0 d-flex align-items-center" href="account-addresses.html">
                                <svg className="text-gray-600 float-start" width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <li className="nav-item">
                            <a className="nav-link px-0 d-flex align-items-center" href="account-settings.html">
                                <svg className="text-gray-600 float-start" width="18px" height="18px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                <path fillRule="evenodd" d="M.102 2.223A3.004 3.004 0 0 0 3.78 5.897l6.341 6.252A3.003 3.003 0 0 0 13 16a3 3 0 1 0-.851-5.878L5.897 3.781A3.004 3.004 0 0 0 2.223.1l2.141 2.142L4 4l-1.757.364L.102 2.223zm13.37 9.019L13 11l-.471.242-.529.026-.287.445-.445.287-.026.529L11 13l.242.471.026.529.445.287.287.445.529.026L13 15l.471-.242.529-.026.287-.445.445-.287.026-.529L15 13l-.242-.471-.026-.529-.445-.287-.287-.445-.529-.026z"></path>
                                </svg>
                            ...
                            <li className="nav-item">
                                <a className="nav-link px-0 d-flex align-items-center" href="#">
                                    <span className="group-icon">
                                        <i className="fi fi-arrow-end"></i>
        ...
        <nav className="navbar navbar-expand-lg navbar-light justify-content-lg-between justify-content-md-inherit">
            <div className="align-items-start">
                <a className="navbar-brand" href="/">
                    <img src="/images/logo/logo_dark.svg" width="200" height="38"  />
                </a>
